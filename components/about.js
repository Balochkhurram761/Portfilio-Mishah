...
const skills = [
  { type: "Adobe Premiere Pro", level: 95 },
  { type: "After Effects", level: 85 },
  { type: "DaVinci Resolve", level: 90 },
  { type: "Color Grading", level: 90 },
  { type: "Sound Design", level: 80 },
  { type: "Motion Graphics", level: 85 },
];
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="bg-[#111] border border-orange-500/10 rounded-2xl p-8">
            ...
            <div className="flex gap-4 mt-8 flex-wrap">
              <div className="w-14 h-14 rounded-xl border border-orange-500 flex items-center justify-center bg-black">
                <Image src="/pr.jpg" alt="" width={32} height={32} />
              </div>
          ...
          <div className="bg-[#111] border border-orange-500/10 rounded-2xl p-8">
            ...
            <Link
              ...
              target="_blank"
              className="mt-6 inline-block bg-orange-500 hover:bg-orange-600 px-6 py-4 rounded-lg transition"
            >
              Download Resume
            </Link>
          </div>
